 ...
 */
public class AuthorCard extends javax.swing.JPanel {
    data.Author author;
    /**
     * Creates new form Author
     */
    public AuthorCard(data.Author author){
        this.author = author;
        initComponents();
        if(author.smallPicture != null) {
            this.picture.setIcon(author.smallPicture);
        }
        this.name.setText(author.name);
        this.lifespan.setText(author.birth + " - " + author.death);
    }
    ...
    private void pictureMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pictureMouseClicked
        Information info = new Information(author);
